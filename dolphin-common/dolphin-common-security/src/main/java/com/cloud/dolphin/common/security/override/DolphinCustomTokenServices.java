 ...
 *<p>
 * 自定义 token 放发处理逻辑
 * 重写DefaultTokenServices,如果身份验证已更改在创建时重新获取token并删除旧token
 *</p>
 *
 * @Author: entfrm开发团队-王翔
 * @Date: 2022/2/17
 */
public class DolphinCustomTokenServices implements AuthorizationServerTokenServices, ResourceServerTokenServices,
