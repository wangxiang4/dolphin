...
import com.cloud.dolphin.common.feign.DolphinFeignAutoConfiguration;
 ...
 * @Date: 2022/2/17
 */
public class DolphinFeignClientsRegistrar implements ImportBeanDefinitionRegistrar, BeanClassLoaderAware, EnvironmentAware {
	...
	private Class<?> getSpringFactoriesLoaderFactoryClass() {
		return DolphinFeignAutoConfiguration.class;
	}
