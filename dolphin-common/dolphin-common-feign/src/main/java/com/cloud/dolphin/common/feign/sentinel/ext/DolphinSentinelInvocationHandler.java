 ...
 */
@Slf4j
public class DolphinSentinelInvocationHandler implements InvocationHandler {
	...
	DolphinSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			DolphinSentinelInvocationHandler other = (DolphinSentinelInvocationHandler) obj;
